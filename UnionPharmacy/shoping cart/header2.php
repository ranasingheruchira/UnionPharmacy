...
<body> 
	...
	<header>	
		<a class="logo-wed" href="#"><img alt="Wedding Planner Logo" src="../images/main/logo new.png" style="width:130px; margin:1%;"></a> 
		<nav class="t-nav">
		<div class="top-nav">
		<ul class="menu-bar">
		...
		<a href="index.php">	<img id="log-bag" src="../images/main/bag.png" ></img> </a>
		<?php
